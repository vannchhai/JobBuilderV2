...
<h2 class="product-title">Manage Job</h2>
<ol class="breadcrumb">
<li><a href="#"><i class="ti-home"></i> Home</a></li>
<li class="current">Manage Job</li>
</ol>
</div>
</div>
</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-sm-8 col-xs-12">
				...
				<h3 class="alerts-title">Manage Job</h3>

				@foreach($listManageJob as $item)
			            ...
			            <div class="job-list">
			              <div class="thumb">
			                ...
			                $adLogo = '';
			                  ...
			                  if (is_file(public_path().'/uploads/pictures/logo/logo_'. $user->id .'.jpg')) {
			              ...
			              <div class="job-list-content">
			                ...
			                <div class="job-tag">
			                  ...
			                  <div class="pull-right">
			                    <a href="{{ url('EditJob').'/'.$item->id }}" class="btn btn-common btn-rm">Edit</a>
			                    <a href="{{ url('RemoveJob').'/'.$item->id }}" class="btn btn-common btn-rm">Remove</a>
			                  </div>
			                </div>
			              </div>
			            </div>
