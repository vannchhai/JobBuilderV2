...
<h2 class="product-title">Pending Job</h2>
<ol class="breadcrumb">
<li><a href="#"><i class="ti-home"></i> Home</a></li>
<li class="current">Pending Job</li>
</ol>
</div>
</div>
</div>
...
<div class="col-md-8 col-sm-8 col-xs-12">
	...
	<h3 class="alerts-title">Pending Job</h3>
            ...
            <div class="job-list">
              <div class="thumb">
                ...
                $adLogo = '';
                  ...
                  if ($adLogo=='') {
                    $adLogo = url('images/default-250x200.jpg');
                  }
                 ?>
              ...
              <div class="job-list-content">
                ...
                <div class="job-tag">
                  ...
                  <div class="pull-right">
                    <a href="{{ url('RemovePending').'/'.$item->id }}" class="btn btn-common btn-rm">Remove</a>
                  </div>
                </div>
              </div>
            </div>
